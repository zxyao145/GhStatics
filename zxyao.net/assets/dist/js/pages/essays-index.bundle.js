...
/***/ "./src/scss/pages/essays-index.scss":
/*!******************************************!*\
  !*** ./src/scss/pages/essays-index.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__(/*! ../../scss/pages/essays-index.scss */ "./src/scss/pages/essays-index.scss");
var global_1 = __importDefault(__webpack_require__(/*! ../common/global */ "./src/ts/common/global.ts"));
(function () {
    var essayList = "/api/Essays/Index";
    var hotEssay = "/api/Essays/Hot";
    var latestEssay = "/api/Essays/Latest";
    var essayTypes = "/api/Taxonomy/EssayTypes";
    var tags = "/api/Taxonomy/Tags";
    var loadCount = 0;
    ...
    var paging = new Paging_1.default("#paginationContainer", function (page) {
        window.location.href = "/Essays?page=" + page;
    }, true);
    function getEssaySummary(page) {
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                blogSummary_1.default.create(pagingData.Data, '#bIContainer', true);
                ...
                success: function (msg) {
                    if (msg.Code === 0) {
                        ...
                        var html = data.map(function (item, index) {
                            ...
                            return "<li><span class=\"" + className + "\">" + (index + 1) + "</span><a href=\"/Essays/Details/" + item.Slug + "\">" + item.Title + "</a></li>";
                        }).join(" ");
                        $("#latest").html("<ul>" + html + "</ul>");
                    }
                }
            });
        };
                ...
                success: function (msg) {
                    if (msg.Code === 0) {
                        ...
                        var html = data.map(function (item, index) {
                            ...
                            return "<li><span class=\"" + className + "\">" + item.ReadNum + "</span><a href=\"/Essays/Details/" + item.Slug + "\">" + item.Title + "</a></li>";
                        }).join(" ");
                        $("#hot").html("<ul>" + html + "</ul>");
                    }
                }
                ...
                success: function (msg) {
                    if (msg.Code === 0) {
                        ...
                        var html = data.map(function (item) {
                            return "<li><a href=\"/Taxonomy/EssayType?Id=" + item.Id + "\">" + item.Name + "</a><span class=\"badge badge-info\">" + item.Num + "</span></li>";
                        }).join(" ");
                        $("#essayTypes").html("<ul>" + html + "</ul>");
                    }
                }
            });
        };
            ...
            $.ajax({
                ...
                success: function (msg) {
                    if (msg.Code === 0) {
                        var data = msg.Data;
                        var html = data.map(function (item) {
                            return "<li><a class=\"btn btn-light btn-sm\" href=\"/Taxonomy/Tag?Id=" + item.Id + "\">" + item.Name + " <span class=\"badge badge-info\">" + item.Num + "</span></a></li>";
                        }).join(" ");
                        $("#tags").html("<ul>" + html + "</ul>");
                    }
                }
            });
        };
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/ts/pages/essays-index.ts");
/******/ 	
/******/ })()
;
//# sourceMappingURL=essays-index.bundle.js.map